...
public class CameraControl : MonoBehaviour
{
	...
	void MoveCamera()
	{
		...
		camObj.transform.position = new Vector3(Mathf.Clamp(camObj.transform.position.x, xBound[0], xBound[1]), camObj.transform.position.y, Mathf.Clamp(camObj.transform.position.z, zBound[0], zBound[1]));
